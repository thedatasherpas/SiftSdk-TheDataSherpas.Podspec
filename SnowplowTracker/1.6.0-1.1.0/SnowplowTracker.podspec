Pod::Spec.new do |s|
  ...
  s.source           = { :git => "git@github.comcast.com:ProductAnalyticsBehaviorScience/snowplow-ios-tracker.git", :tag => s.version.to_s }
